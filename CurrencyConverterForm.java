...
public static float usd = CurrencyConvert.getUSD();
public static float eur = CurrencyConvert.getEUR();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "RUB", "USD", "EUR" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "RUB", "USD", "EUR" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if ("RUB".equals(tmpS)) { x = 1; } else if ("USD".equals(tmpS)) { x = usd; } else { x = eur; }
        if ("RUB".equals(tmpS2)) { y = 1; } else if ("USD".equals(tmpS2)) { y = usd; } else { y = eur; }
